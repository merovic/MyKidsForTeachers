...
public class SettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(language==1)
        {
            ...
            english.setTextColor(Color.parseColor("#018F7D"));

            arabic.setBackgroundColor(Color.parseColor("#018F7D"));
        ...
        }else
        {
            ...
            arabic.setTextColor(Color.parseColor("#018F7D"));

            english.setBackgroundColor(Color.parseColor("#018F7D"));
