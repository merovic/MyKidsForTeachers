...
import com.amirahmed.mykidsforteachers.Adapters.NotificationsAdapter;
import com.amirahmed.mykidsforteachers.Main2Activity;
import com.amirahmed.mykidsforteachers.Models.NotificationItem;
        ...
        if(language==1)
        {
            ...
            arrow.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(NotificationsActivity.this , Main2Activity.class);
